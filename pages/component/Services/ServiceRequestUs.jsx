            ...
            <div className="col-span-6">
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                <div className="mb-4 mt-2">
                  <label className="block form-text  text-gray-700 text-sm font-bold mb-2" for="text">
                    Name
                  </label>
                  <input type="text"
                ...
                <div className="mb-4">
                  <label className="block form-texts  text-gray-700 text-sm font-bold mb-2" for="text">
                    Message
                  </label>
...
export default ServiceRequestUs;